...
(3) a brief hands-on guide to downloading data and using our [R code] (https://github.com/DerKevinRiehl/bondTradingDataSqliteDbConverterR) to generate the SQLiteDB with our code, and 
(4) a brief overview of the number of bond trades we found for our downloaded copy of the FINRA TRACE data. 
